...
class ListCategories extends Request
{
	 ...
	 * @param null|string $with Includes the detail information, the active clients (stores) list of the category, all linked tags and their information and/or the linked Elmar category for each client. Available values: details, clients, elmarCategories, tags
	 ...
	 * @param null|int $tagId Filter restricts the list of results to items with a specific tag
	 * @param null|string $metaKeywords Filter restricts the list of results to items with a specific meta keyword. Possible search operators are 'like' and 'eq'.
	 */
