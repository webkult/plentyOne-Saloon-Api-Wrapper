 ...
 *
 * Deletes the text saved for a specific property of the type Text in the specified language. The ID of
 * the property  and the language must be specified.
 */
class DeletePropertyValueTextByLanguage extends Request
{
