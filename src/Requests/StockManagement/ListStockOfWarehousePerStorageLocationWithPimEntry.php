...
/**
 * List stock of a warehouse per storage location with pim entry
 *
 * Lists stock of a warehouse for each variation and storage location with pim entry. The stock will
 * only be listed if the stock is positive. Negative stock will not be listed. The ID of the warehouse
 * must be specified.
 */
class ListStockOfWarehousePerStorageLocationWithPimEntry extends Request
{
	...
	{
		return "/rest/stockmanagement/warehouses/{$this->warehouseId}/stock/storageLocationsPim";
	}
