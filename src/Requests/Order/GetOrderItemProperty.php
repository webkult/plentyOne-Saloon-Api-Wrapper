 ...
 * Gets an order item property.
 * The order item ID and the order item property type ID must be specified. The following property
 ...
 * </ul>
 */
class GetOrderItemProperty extends Request
{
