 ...
 * Get property type
 *
 * Gets a property type and its names in all languages. Optionally, one or more languages can be
...
class GetPropertyType extends Request
{
	 ...
	 * @param null|array $lang If no parameter is set here, all languages for the property are loaded by default. Optionally, enter an arry containing the ISO codes of the desired languages.
	 */
