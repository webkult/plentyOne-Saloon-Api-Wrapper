 ...
 * Get orders
 *
 * Gets orders. The IDs of the orders must be specified.
 */
class GetOrders extends Request
{
	...
	{
		return array_filter(['orderIds' => $this->orderIds, 'with' => $this->with, 'addOrderItems' => $this->addOrderItems]);
	}
}
