 ...
 * order. The ID of the order and the ID of the order property type must be specified. The following
 ...
 * </ul>
 */
class DeletePropertyOfOrderByOrderIdAndPropertyTypeId extends Request
{
