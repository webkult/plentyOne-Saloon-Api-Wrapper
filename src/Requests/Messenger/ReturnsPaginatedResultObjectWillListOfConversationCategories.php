...
/**
 * Returns a paginated result object will list of conversation categories
 *
 * Returns a paginated result object will list of conversation categories
 */
class ReturnsPaginatedResultObjectWillListOfConversationCategories extends Request
{
