...
/**
 * Search conversation based on provided parameters
 *
 * Search conversation based on provided parameters
 */
class SearchConversationBasedOnProvidedParameters extends Request implements HasBody
{
	use HasJsonBody;
	...
	{
		return "/rest/conversations/search";
	}
