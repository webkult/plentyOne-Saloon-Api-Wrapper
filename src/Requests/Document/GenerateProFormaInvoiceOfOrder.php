 ...
 *
 * Generate pro forma invoice of an order. The ID of the order must be specified.
 * The document can only
 * be generated for orders of the type 'order', 'warranty', 'repair', 'advance order' and 'delivery
 * order'.
 */
class GenerateProFormaInvoiceOfOrder extends Request implements HasBody
{
	use HasJsonBody;
	...
	{
		return "/rest/orders/{$this->orderId}/documents/pro_forma_invoice/generate";
	}
