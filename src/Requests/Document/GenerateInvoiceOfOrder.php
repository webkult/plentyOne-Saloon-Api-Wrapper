 ...
 *
 * Generate invoice of an order. The ID of the order must be specified.
 * The document can only be
 * generated for orders of the type 'order', 'warranty', 'repair' and 'advance order'.
 */
class GenerateInvoiceOfOrder extends Request implements HasBody
{
	use HasJsonBody;
	...
	{
		return "/rest/orders/{$this->orderId}/documents/invoice/generate";
	}
	...
	public function defaultQuery(): array
	{
		return array_filter([
			...
			'allowRegenerate' => $this->allowRegenerate,
