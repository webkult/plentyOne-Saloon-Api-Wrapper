 ...
 *
 * Generate success confirmation of an order. The ID of the order must be specified.
 * The document can
 * only be generated for orders of the type 'order', 'warranty', 'repair', 'advance order' and 'offer'.
 */
class GenerateSuccessConfirmationOfOrder extends Request implements HasBody
{
	use HasJsonBody;
	...
	{
		return "/rest/orders/{$this->orderId}/documents/success_confirmation/generate";
	}
