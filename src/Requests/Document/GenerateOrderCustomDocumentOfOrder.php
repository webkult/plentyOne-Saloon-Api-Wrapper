...
/**
 * Generate order custom document of an order
 *
 * Generate order custom document of an order. The ID of the order must be specified.
 */
class GenerateOrderCustomDocumentOfOrder extends Request implements HasBody
{
	use HasJsonBody;
	...
	{
		return "/rest/orders/{$this->orderId}/documents/order_custom/generate";
	}
