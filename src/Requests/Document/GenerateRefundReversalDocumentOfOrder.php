 ...
 *
 * Generate refund reversal document of an order. The ID of the order must be specified.
 * The document
 * can only be generated for orders of the type 'credit note'. A valid credit note document must exist.
 */
class GenerateRefundReversalDocumentOfOrder extends Request implements HasBody
{
	use HasJsonBody;
	...
	{
		return "/rest/orders/{$this->orderId}/documents/reversal_refund/generate";
	}
