 ...
 *
 * Generate reversal document of an order. The ID of the order must be specified.
 * The document can only
 * be generated for orders of the type 'order', 'warranty', 'repair' and 'advance order'. A valid
 * invoice must exist.
 */
class GenerateReversalDocumentOfOrder extends Request implements HasBody
{
	use HasJsonBody;
	...
	{
		return "/rest/orders/{$this->orderId}/documents/reversal_document/generate";
	}
