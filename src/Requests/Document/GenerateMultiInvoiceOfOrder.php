...
/**
 * Generate multi-invoice of an order
 *
 * Generate multi-invoice of an order. The ID of the order must be specified.
 * The document can only be
 * generated for orders of the type 'multi order'.
 */
class GenerateMultiInvoiceOfOrder extends Request implements HasBody
{
	use HasJsonBody;
	...
	{
		return "/rest/orders/{$this->orderId}/documents/multi_invoice/generate";
	}
