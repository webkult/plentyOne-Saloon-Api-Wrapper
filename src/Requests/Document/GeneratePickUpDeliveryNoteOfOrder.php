 ...
 *
 * Generate pick-up delivery note of an order. The ID of the order must be specified.
 * The document can
 * only be generated for orders of the type 'order', 'warranty' and 'repair'.
 */
class GeneratePickUpDeliveryNoteOfOrder extends Request implements HasBody
{
	use HasJsonBody;
	...
	{
		return "/rest/orders/{$this->orderId}/documents/pickup_delivery/generate";
	}
