 ...
 *
 * Generate repair slip of an order. The ID of the order must be specified.
 * The document can only be
 * generated for orders of the type 'repair'.
 */
class GenerateRepairSlipOfOrder extends Request implements HasBody
{
	use HasJsonBody;
	...
	{
		return "/rest/orders/{$this->orderId}/documents/repair_bill/generate";
	}
