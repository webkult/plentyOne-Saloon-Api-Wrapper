 ...
 *
 * Generate return slip of an order. The ID of the order must be specified.
 * The document can only be
 * generated for orders of the type 'order', 'warranty', 'repair' and 'returns'.
 */
class GenerateReturnSlipOfOrder extends Request implements HasBody
{
	use HasJsonBody;
	...
	{
		return "/rest/orders/{$this->orderId}/documents/return_note/generate";
	}
