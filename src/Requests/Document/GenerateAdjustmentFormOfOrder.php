 ...
 *
 * Generate adjustment form of an order. The ID of the order must be specified.
 * The document can only
 * be generated for orders of the type 'credit note'.
 */
class GenerateAdjustmentFormOfOrder extends Request implements HasBody
{
	use HasJsonBody;
	...
	{
		return "/rest/orders/{$this->orderId}/documents/correction_document/generate";
	}
